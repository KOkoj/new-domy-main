...
import { isPropertyAlias, resolvePropertySlug } from '@/lib/propertyAliases'
...
export async function getAllProperties(searchParams) {
  ...
  filteredProperties = filteredProperties.filter(property => isDisplayableProperty(property) && !isPropertyAlias(property))

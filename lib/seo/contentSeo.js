...
export function buildPropertyJsonLd(property, canonicalPath) {
  ...
  if (specifications?.rooms) mainEntity.numberOfRooms = specifications.rooms
  if (specifications?.bedrooms) mainEntity.numberOfBedrooms = specifications.bedrooms
  if (specifications?.bathrooms) mainEntity.numberOfBathroomsTotal = specifications.bathrooms

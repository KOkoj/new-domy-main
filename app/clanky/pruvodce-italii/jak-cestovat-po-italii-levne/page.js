...
const CAR_RENT_PARTNER_LINKS = {
  homepage: AFFILIATE_LINKS.carRental.click,
  trackingPixel: AFFILIATE_LINKS.carRental.pixel
}
...
const SIDEBAR_TRAVEL_WIDGET = {
  href: AFFILIATE_LINKS.banners.travelSidebar.click,
  image: AFFILIATE_LINKS.banners.travelSidebar.image
}
...
function TransportCard({ icon, title, text, official, examples, cta }) {
  ...
  return (
    <Card className="bg-white border border-slate-200">
      <CardHeader>
        <CardTitle className="flex items-center gap-3 mb-8">
          {icon}
          {title}
        </CardTitle>
      </CardHeader>
  ...
  const articleImage =
    language === 'cs'
      ...
      : language === 'it'
        ? {
            src: 'https://images.unsplash.com/photo-1474487548417-781cb71495f3?auto=format&fit=crop&w=1400&q=80',
            alt: 'Treno e autobus per viaggiare in Italia',
            caption: 'Il miglior equilibrio tra costo e flessibilità arriva spesso dalla combinazione di treno, bus e prenotazione anticipata.'
          }
        : {
            src: 'https://images.unsplash.com/photo-1474487548417-781cb71495f3?auto=format&fit=crop&w=1400&q=80',
            alt: 'Train and bus travel in Italy',
      ...
      <main className="pt-28 pb-16 md:pb-24">
        <div className="container mx-auto px-6" style={{ maxWidth: '1200px' }}>
          <div className="max-w-[1200px] mx-auto lg:grid lg:grid-cols-[minmax(0,1fr)_200px] lg:gap-8 xl:gap-12">
            ...
            <Card className="bg-white border border-slate-200">
              <CardHeader>
                <CardTitle className="mb-8">{t.watchoutsTitle}</CardTitle>
              </CardHeader>
              <CardContent>
                <ul className="list-disc pl-6 space-y-2 text-slate-700">
            ...
            <Card className="bg-white border border-slate-200">
              <CardHeader>
                <CardTitle className="mb-8">{t.strategyTitle}</CardTitle>
              </CardHeader>
              <CardContent>
                <ul className="list-disc pl-6 space-y-2 text-slate-700">
                  {t.strategy.map((line) => (
            ...
            <LeadMagnetBanner assetKey="mistakes" language={language} />
              ...
              <Card className="bg-white border border-slate-200">
                <CardHeader>
                  <CardTitle className="mb-8">{t.conclusion.title}</CardTitle>
                </CardHeader>
                <CardContent className="space-y-3 text-slate-700 leading-relaxed">

...
const LEGAL_COPY = {
  ...
  cs: {
    termsLabel:
      'Potvrzuji, ze jsem cetl(a) a prijimam obchodni podminky pro digitalni obsah.',
    privacyLabel:
      'Potvrzuji, ze jsem cetl(a) informace o ochrane osobnich udaju (GDPR) pro nakup a podporu.',
    digitalWaiverLabel:
      'Zadam o okamzite dodani digitalniho obsahu a beru na vedomi ztratu prava na odstoupeni po zahajeni stahovani.'
  }
}

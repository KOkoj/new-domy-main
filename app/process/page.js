...
const PROCESS_STEPS = [
  ...
  },
  {
    ...
    subtitle: {
      ...
      cs: 'Kontrola, že je vše v pořádku',
    ...
    description: {
      ...
      cs: 'Naši právní a techničtí partneři provádějí důkladné kontroly nemovitosti, včetně ověření vlastnictví, stavebních průzkumů a kontrol souladu.',
...
export default function ProcessPage() {
  ...
  const visibleProcessSteps = PROCESS_STEPS.filter((step) => step.number !== 4)
        ...
        <div className="bg-white/80 backdrop-blur-sm border-b border-gray-200 shadow-sm mb-12">
          <div className="container mx-auto px-4 py-16">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-lg md:text-xl text-gray-600 leading-relaxed mb-8 px-4 whitespace-pre-line">
                {language === 'cs' ? `Plánujete koupi domu nebo bytu v Itálii a chcete mít jistotu, že vše proběhne správně a bez
nepříjemných překvapení? Koupě nemovitosti v Itálii se liší od České republiky – jiný postup, jiná
odpovědnost stran, jiná role notáře. Proto je důležité vědět, jak jednotlivé kroky navazují a co vás v
průběhu čeká. Níže vás přehledně seznámíme s tím, jak spolupráce s námi probíhá. Od prvního
výběru nemovitosti přes právní a administrativní kroky až po převod vlastnictví a následné záležitosti.
Po celou dobu jsme vám k dispozici, vysvětlujeme souvislosti, kontrolujeme detaily a pomáháme vám
projít celým procesem s jistotou a klidem` :

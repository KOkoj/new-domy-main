    ...
    language === 'cs'
      ...
      : language === 'it'
        ? {
            ...
            caption: 'Fuori alta stagione e fuori dai centri più turistici è spesso possibile trovare un ottimo rapporto qualità-prezzo.'
          }
        : {
            src: '/house_tuscany_vineyards.jpg',
        ...
        <div className="container mx-auto px-6" style={{ maxWidth: '1200px' }}>
          <article className="max-w-4xl mx-auto space-y-8" style={{ maxWidth: '720px', marginLeft: 'auto', marginRight: 'auto' }}>
            ...
            <Card className="bg-white border border-slate-200">
              <CardHeader>
                <CardTitle className="mb-8">{t.marketTitle}</CardTitle>
              </CardHeader>
              <CardContent>
            ...
            <div className="flex justify-center">
              <a href={AFFILIATE_LINKS.banners.accommodation.click} target="_top" rel="sponsored noopener noreferrer">
                <img
                  src={AFFILIATE_LINKS.banners.accommodation.image}
                  width="660"
                  height="270"
                  alt=""
                  border="0"
            ...
            <Card className="bg-white border border-slate-200">
              <CardHeader>
                <CardTitle className="mb-8">{t.typesTitle}</CardTitle>
              </CardHeader>
            ...
            <Card className="bg-white border border-slate-200">
              <CardHeader>
                <CardTitle className="mb-8">{t.hotelTitle}</CardTitle>
              </CardHeader>
              <CardContent>
                <ul className="list-disc pl-6 space-y-2 text-slate-700">
                  {t.hotel.map((line) => (
            ...
            <Card className="bg-white border border-slate-200">
              <CardHeader>
                <CardTitle className="mb-8">{t.bnbTitle}</CardTitle>
              </CardHeader>
              <CardContent>
                <ul className="list-disc pl-6 space-y-2 text-slate-700">
                  {t.bnb.map((line) => (
            ...
            <Card className="bg-white border border-slate-200">
              <CardHeader>
                <CardTitle className="mb-8">{t.mistakesTitle}</CardTitle>
              </CardHeader>
              <CardContent>
                <ul className="list-disc pl-6 space-y-2 text-slate-700">
                  {t.mistakes.map((line) => (

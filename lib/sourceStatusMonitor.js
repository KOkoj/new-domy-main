...
import { getLocalProperties, updateLocalProperty } from '@/lib/localPropertiesStore'
...
export async function loadSourceTrackedProperties() {
  const localProperties = (await getLocalProperties()).filter((property) => property?.sourceUrl)

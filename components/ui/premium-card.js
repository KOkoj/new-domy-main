...
export const GlareCard = ({
  ...
  return (
    ...
    >
      ...
      >
        <div 
          className="w-full h-full absolute inset-0 mix-blend-soft-light"
          style={{
        ...
        />
        <div
          className="w-full h-full absolute inset-0 mix-blend-color-dodge opacity-[var(--opacity)] will-change-background transition-opacity relative"
          style={{ 
            ...backgroundStyle,
            clipPath: 'inset(0 0 1px 0 round var(--radius))',
            gridArea: '1/1',

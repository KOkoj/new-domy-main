...
import {
  ...
  REGION_BOOKING_LINKS as CENTRAL_REGION_BOOKING_LINKS,
  REGION_GETYOURGUIDE_LINKS as CENTRAL_REGION_GETYOURGUIDE_LINKS,
  REGION_GETYOURGUIDE_WIDGETS,
  getRegionGetYourGuideWidget,
  getTrackedGetYourGuideLink
} from '@/lib/affiliateLinks'

const DEFAULT_BOOKING_LINK = AFFILIATE_LINKS.booking.default
const REGION_CAR_RENTAL_LINK = AFFILIATE_LINKS.carRental.regionClick
const REGION_BOOKING_LINKS = {
  ...CENTRAL_REGION_BOOKING_LINKS
}
const DEFAULT_GYG_LINK = AFFILIATE_LINKS.getYourGuide.default
const REGION_GYG_LINKS = CENTRAL_REGION_GETYOURGUIDE_LINKS
const REGION_GYG_WIDGET_CONFIGS = Object.fromEntries(
  Object.keys(REGION_GETYOURGUIDE_WIDGETS).map((region) => [region, getRegionGetYourGuideWidget(region)])
)
...
function getTrackedGygLink(link) {
  return getTrackedGetYourGuideLink(link)
}
...
export default function RegionDetailClient({ initialProperties = [] }) {
  ...
  return (
    <div className="min-h-screen bg-[#faf8f5]">
      ...
      {shouldShowRegionalWidget ? (
        <Script
          src={AFFILIATE_LINKS.getYourGuide.widgetScript}

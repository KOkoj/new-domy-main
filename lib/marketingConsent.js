...
const COPY = {
  it: {
    checkboxLabel:
      'Acconsento a ricevere email promozionali da Domy v Italia (es. guide premium, offerte e aggiornamenti commerciali).',
    helper:
      "Consenso facoltativo e revocabile in qualsiasi momento dalle preferenze dell'account.",
  ...
  en: {
    checkboxLabel:
      'I agree to receive marketing emails from Domy v Italia (e.g. premium guides, offers, and commercial updates).',
    helper:

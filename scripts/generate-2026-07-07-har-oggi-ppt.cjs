...
const OUT_DIR = path.join(ROOT, "tmp", "ppt-build", "har-oggi-2026-07-07");
const OUTPUT = path.join(ROOT, "tmp", "selezione-har-oggi-2026-07-07.pptx");
const ICON_STRIP = path.join(ROOT, "tmp", "ppt-build", "extracted", "ppt", "media", "image1.png");

const ITEMS = [
  { index: 1, har: "1har.har", url: "https://www.idealista.it/immobile/32501587/" },
  { index: 2, har: "2har.har", url: "https://www.idealista.it/immobile/32911558/" },
  { index: 3, har: "3har.har", url: "https://www.idealista.it/immobile/33413312/" },
  { index: 4, har: "4har.har", url: "https://www.idealista.it/immobile/33613679/" },
  { index: 5, har: "5har.har", url: "https://www.immobiliare.it/annunci/128393126/" },
  { index: 6, har: "6har.har", url: "https://www.immobiliare.it/annunci/128270700/" },
  { index: 7, har: "7har.har", url: "https://www.immobiliare.it/annunci/116230705/" },
  { index: 8, har: "8har.har", url: "https://www.immobiliare.it/annunci/118586549/" },
  { index: 9, har: "9har.har", url: "https://www.immobiliare.it/annunci/119949310/" },
  { index: 10, har: "10har.har", url: "https://www.immobiliare.it/annunci/122473366/" },
  { index: 11, har: "11har.har", url: "https://www.immobiliare.it/annunci/130502096/" },
];
...
const PERFECT_CZECH_TITLES = {
  1: "Byt ve Via Benedetto Croce v Gubbiu",
  2: "Prostorný byt ve Via Leonardo da Vinci v Gubbiu",
  3: "Podkrovní byt ve Via Meucci v Gubbiu",
  4: "Čtyřpokojový byt ve Via Luigi Bellucci v Gubbiu",
  5: "Dvoupokojový byt v Casanova di Torre u Gubbia",
  6: "Dvoupokojový byt v Padule San Marco u Gubbia",
  7: "Samostatná vila v Loreto Basso u Gubbia",
  8: "Čtyřpokojový byt v Padule San Marco u Gubbia",
  9: "Řadový dům v Cipolletu u Gubbia",
  10: "Čtyřpokojový byt v centru Gubbia",
  11: "Venkovské stavení u Gubbia",
};

const PERFECT_CZECH_DESCRIPTIONS = {
  1: "Byt ve Via Benedetto Croce v okrajové části Gubbia nabízí přibližně 95 m2 a cenu 89 000 EUR. Jde o praktickou městskou variantu pro kupující, kteří chtějí zůstat v dosahu služeb Gubbia, ale zároveň hledají klidnější rezidenční prostředí mimo nejužší historické centrum.\n\nZ dostupných fotografií je patrné klasické dispoziční řešení s obytnými místnostmi a dobrým potenciálem pro vlastní úpravy. Před dalším krokem doporučuji ověřit stav domu, společné náklady, přesnou dispozici, technické instalace a možnosti parkování v okolí.",
  2: "Prostorný byt ve Via Leonardo da Vinci v Gubbiu má přibližně 100 m2 a cenu 90 000 EUR. Nabídka působí jako solidní volba pro klienta, který hledá větší byt v rezidenční části města, s lepším poměrem ceny a plochy než u nemovitostí přímo v historickém centru.\n\nSilnou stránkou je použitelná metráž a poloha v běžné obytné zóně. U této nemovitosti je důležité prověřit stav interiéru, případné náklady na modernizaci, energetickou náročnost, správu domu a skutečnou docházkovou dostupnost služeb.",
  3: "Podkrovní byt ve Via Meucci v Gubbiu nabízí přibližně 90 m2 za 79 000 EUR. Díky poloze v horní části domu může být zajímavý pro kupující, kteří hledají vzdušnější byt s větším soukromím a nechtějí investovat do příliš drahé nemovitosti.\n\nPři prohlídce je potřeba soustředit se hlavně na stav střechy, izolaci, letní přehřívání, vytápění a případné náklady spojené s horním podlažím. Pokud jsou technické parametry v pořádku, může jít o velmi rozumný kompromis mezi cenou, plochou a lokalitou.",
  4: "Čtyřpokojový byt ve Via Luigi Bellucci v Gubbiu má přibližně 80 m2 a cenu 90 000 EUR. Nabídka cílí na kupující, kteří hledají kompaktní, ale stále dobře využitelný byt v městském prostředí, vhodný pro vlastní bydlení, delší pobyty i jednodušší pronájem.\n\nHodnota této nemovitosti bude záviset především na reálném stavu interiéru, orientaci, světle, společných částech domu a nákladech na případné úpravy. Před rozhodnutím je vhodné ověřit také právní dokumentaci, poplatky a přesné vymezení příslušenství.",
  5: "Dvoupokojový byt v lokalitě Casanova di Torre u Gubbia nabízí přibližně 80 m2 a cenu 78 000 EUR. Poloha mimo nejrušnější centrum může být zajímavá pro klienta, který hledá klidnější prostředí, nižší vstupní cenu a jednoduchou nemovitost jako základnu v Umbrii.\n\nNabídka působí spíše prakticky než reprezentativně. Je vhodné ověřit dopravní dostupnost, stav interiéru, vytápění, vlhkost, parkování a skutečnou vzdálenost od služeb. Pro správného kupujícího může jít o dostupnou variantu s dobrým poměrem ceny a využitelné plochy.",
  6: "Dvoupokojový byt ve Via Monza v části Padule San Marco u Gubbia má přibližně 90 m2 a cenu 90 000 EUR. Nabídka je zajímavá hlavně pro ty, kdo hledají jednodušší rezidenční bydlení v okolí Gubbia, s větší plochou než u standardního menšího bytu.\n\nFotografie ukazují klasický obytný charakter a prostor, který může po úpravách fungovat jako pohodlné zázemí pro dlouhodobé pobyty. Před koupí je nutné prověřit stav instalací, kvalitu oken, vytápění, společné náklady a praktické napojení na Gubbio.",
  7: "Samostatná vila v lokalitě Loreto Basso u Gubbia nabízí přibližně 80 m2 za 98 000 EUR. Oproti bytům v tomto výběru je hlavní hodnotou samostatnější charakter bydlení a venkovnější poloha, která může lépe vyhovovat klientovi hledajícímu klid a větší soukromí.\n\nU této nabídky je zásadní technická kontrola: stav střechy, fasády, instalací, přístupové cesty, pozemku a případných hospodářských nebo venkovních částí. Pokud jsou základní konstrukce v pořádku, může jít o zajímavou alternativu k městskému bytu.",
  8: "Čtyřpokojový byt ve Via dei Cinque Colli v části Padule San Marco u Gubbia má přibližně 85 m2 a cenu 83 000 EUR. Nabídka působí jako dostupné rodinnější řešení v klidnější části mimo centrum, s rozumnou plochou a nižší vstupní cenou.\n\nSilnou stránkou je poměr ceny, metráže a lokality. Při prohlídce je potřeba ověřit zejména stav koupelny a kuchyně, vytápění, vlhkost, kvalitu oken, parkování a celkový stav budovy. Nemovitost může dávat smysl jako trvalejší zázemí i jako rekreační byt v Umbrii.",
  9: "Řadový rodinný dům ve Via Europa v Cipolletu u Gubbia nabízí přibližně 90 m2 a cenu 84 000 EUR. Oproti bytovým nabídkám přidává samostatnější způsob bydlení a typologii domu, která může být atraktivnější pro klienta hledajícího vlastní vstup a více soukromí.\n\nDům je vhodné posuzovat hlavně podle technického stavu, dispozice, možnosti úprav a reálných provozních nákladů. Před dalším krokem doporučuji prověřit konstrukce, střechu, vytápění, právní stav a také to, zda venkovní části odpovídají očekávání kupujícího.",
  10: "Čtyřpokojový byt ve Via Antonio Meucci v centru Gubbia má přibližně 75 m2 a cenu 79 000 EUR. Díky centrálnější poloze může být zajímavý pro kupující, kteří chtějí být blízko městského života, služeb a historického prostředí Gubbia.\n\nMenší plocha je vyvážena lokalitou a cenou. U bytu v centru je nutné pečlivě ověřit přístup, parkování, stav domu, hluk, světlo, případná omezení historické zástavby a náklady na správu. Při dobrém technickém stavu může jít o velmi použitelnou městskou základnu.",
  11: "Venkovské stavení ve Via del Poderaccio u Gubbia nabízí přibližně 105 m2 a cenu 79 000 EUR. Z celého výběru působí nejvíce venkovsky a může oslovit kupujícího, který hledá charakter, klidnější prostředí a možnost vytvořit si vlastní zázemí mimo městský provoz.\n\nU podobné nemovitosti je rozhodující technická a právní prověrka. Je potřeba ověřit stav konstrukcí, střechy, příjezd, hranice pozemku, inženýrské sítě, vytápění a případné stavební nebo katastrální nesrovnalosti. Potenciál je zajímavý, ale vyžaduje pečlivou kontrolu na místě.",
};
...
function decodeHarBuffer(content) {
...
function extractIdealistaPrice(raw, html) {
  const candidates = [
  ...
  for (const candidate of candidates) {
    const digits = htmlToText(candidate || "").replace(/[^\d]/g, "");
    if (digits) return Number(digits).toLocaleString("it-IT");
  }
  return "";
}

function idealistaImageKey(url) {
  return String(url || "").match(/\/(\d+)\.(?:jpg|jpeg|png|webp)(?:\?|$)/i)?.[1] || String(url || "");
}

function idealistaImageRank(url) {
  const value = String(url || "");
  let score = 0;
  if (/WEB_DETAIL_TOP-L-L/i.test(value)) score += 90;
  else if (/WEB_DETAIL/i.test(value)) score += 70;
  else if (/XL/i.test(value)) score += 40;
  if (/\.jpe?g($|\?)/i.test(value)) score += 5;
  if (/\.webp($|\?)/i.test(value)) score += 3;
  return score;
}

function saveIdealistaImages(entries, outDir) {
  const imageEntries = entries
    .filter((entry) => /^image\//i.test(entry?.response?.content?.mimeType || ""))
    .filter((entry) => /img4\.idealista\.it/i.test(entry?.request?.url || ""))
    .filter((entry) => decodeHarBuffer(entry?.response?.content));

  const bestByAsset = new Map();
  for (const entry of imageEntries) {
    const url = entry.request.url;
    const key = idealistaImageKey(url);
    const prev = bestByAsset.get(key);
    if (!prev || idealistaImageRank(url) > idealistaImageRank(prev.request.url)) {
  ...
  const galleryPaths = [];
  let index = 1;
  for (const entry of Array.from(bestByAsset.values()).slice(0, 24)) {
    const url = entry.request.url;
    const content = entry.response.content || {};
    const ext = extFromUrl(url);
    const filePath = path.join(outDir, `gallery-${index}${ext}`);
    fs.writeFileSync(filePath, decodeHarBuffer(content));
...
function extractIdealistaFromHar(harPath, outDir, item) {
  const raw = fs.readFileSync(harPath, "utf8");
  const parsed = JSON.parse(raw);
  const entries = parsed?.log?.entries || [];
  const htmlEntry =
    entries.find((entry) => /text\/html/i.test(entry?.response?.content?.mimeType || "") && /idealista\.it\/immobile\//i.test(entry?.request?.url || "")) ||
    entries.find((entry) => /text\/html/i.test(entry?.response?.content?.mimeType || ""));
  const html = decodeHtmlEntities(decodeHarBuffer(htmlEntry?.response?.content)?.toString("utf8") || raw);
  const galleryPaths = saveIdealistaImages(entries, outDir);
  const details = [...html.matchAll(/<li>([\s\S]*?)<\/li>/gi)].map((match) => htmlToText(match[1])).filter(Boolean);
  const infoFeatures = htmlToText(html.match(/<div class="info-features">([\s\S]*?)<\/div>/i)?.[1] || "");
  ...
  const city =
    ...
    ogDescription.split(",").slice(-1)[0] ||
    "";
  const description =
    htmlToText(html.match(/<div class="comment">[\s\S]*?<p>([\s\S]*?)<\/p>/i)?.[1] || "") ||
    ogDescription;
  const surface =
    (infoFeatures.match(/(\d+(?:[.,]\d+)?)\s*m(?:2|q|²)/i)?.[0] || details.find((item) => /m(?:2|q|²)/i.test(item)) || "").replace(/m²|mq/gi, "m2");
  const rooms = infoFeatures.match(/(\d+)\s+locali?/i)?.[0] || details.find((item) => /\blocali?\b/i.test(item)) || "";
  const bedrooms = (details.find((item) => /\bcamere?\b/i.test(item)) || description.match(/(\d+)\s+camere?/i)?.[0] || "").match(/\d+/)?.[0] || "";
  const bathrooms = (infoFeatures.match(/(\d+)\s+bagni?/i)?.[1] || (details.find((item) => /\bbagni?\b/i.test(item)) || "").match(/\d+/)?.[0] || "");
  ...
  return {
    ...
    priceLabel: extractIdealistaPrice(raw, html),
    surface: normalizeWhitespace(surface),
    rooms: normalizeWhitespace(rooms),
    bedrooms: normalizeWhitespace(bedrooms),
    bathrooms: normalizeWhitespace(bathrooms),
    mainPhoto: null,
    planPhoto: null,
    gallery: [],
    galleryDetails: galleryPaths.map((filePath) => ({ type: null, caption: "", url: filePath })),
    saved: { planPath: null, mainPath: galleryPaths[0] || null, galleryPaths },
  };
}
...
function czechDescription(listing) {
  if (PERFECT_CZECH_DESCRIPTIONS[listing.index]) {
    return PERFECT_CZECH_DESCRIPTIONS[listing.index];
  }
...
async function loadListings() {
  ...
  for (const item of ITEMS) {
    ...
    let data;
    try {
      data = /idealista\.it/i.test(item.url) ? extractIdealistaFromHar(harPath, listingDir, item) : extractListingData(harPath, listingDir);
    } catch (error) {
    ...
    const listing = {
      ...
      titleCs: PERFECT_CZECH_TITLES[item.index] || "",
...
async function main() {
  ...
  pptx.subject = "Vyber nemovitosti z HAR Idealista e Immobiliare.it";
  pptx.title = "Vyber nemovitosti - 7. cervence 2026";
  pptx.lang = "cs-CZ";

...
const CONTENT = {
  ...
  it: {
    ...
    cta1: {
      ...
      button: 'Come funziona il nostro servizio nella ricerca casa in Italia',
      href: '/process'
    },
    section1: {
              ...
              <Card className="bg-white/90 backdrop-blur-sm">
                ...
                <CardContent>
                  ...
                  <div className="mt-6 rounded-xl overflow-hidden border border-slate-200 bg-slate-50">
                    <img src="/house_tuscany_vineyards.jpg" alt={t.section1.imageAlt} className="w-full h-64 md:h-80 object-cover" />

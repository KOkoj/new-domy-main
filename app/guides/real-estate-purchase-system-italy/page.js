...
const CONTENT = {
  "en": {
    ...
    "risks": [
      "Committing too early: signing or paying deposits before checks are complete.",
      "Document mismatch: real property status differs from cadastral or permit records.",
      "Hidden constraints: easements, rights of way, condominium rules, protected elements.",
      "Municipality surprises: missing permits, unexpected usage restrictions, blocked renovations.",
      "Cost underestimation: assuming listing price is final cost.",
      "Communication errors: small misunderstandings becoming legal or financial problems."
    ],
    ...
    "costs": [
      "Purchase taxes (depends on property type and buyer profile)",
      "Notary-related costs (fees and registration flows)",
      "Agency commission (depending on payment structure and terms)",
      "Technical checks (survey, compliance verification, documentation)",
      "Administrative fees (documents, certificates, registrations)",
  ...
  "it": {
    ...
    "date": "2026-02-11",
    "readTime": "10 min",
    "title": "Come funziona davvero il sistema di acquisto immobiliare in Italia (e perche e diverso dalla Repubblica Ceca)",
    "intro": [
      "Comprare casa in Italia puo essere fluido, ma solo se capisci come e strutturato il sistema.",
      "Per i compratori cechi, la sorpresa principale non e la burocrazia in se. Il punto critico e che le responsabilita sono divise tra piu persone e uffici e nessuno coordina automaticamente tutto al posto tuo."
    ],
    "keyIdea": "Idea chiave: in Italia il processo e sicuro se gestito passo dopo passo. Se lo tratti come una singola transazione, rischi ritardi, costi nascosti e sorprese legali o tecniche.",
    "complexityTitle": "Perche l Italia sembra piu complessa del processo ceco",
    "complexity": [
      "Responsabilita frammentate: ogni professionista copre solo una parte (agenzia, tecnico, comune, banca, traduttore).",
      ...
      "Le regole comunali contano: permessi, vincoli e conformita possono cambiare l uso possibile dell immobile.",
      "Le tempistiche non sono lineari: documenti, approvazioni e appuntamenti non avanzano sempre alla stessa velocita."
    ],
    "complexityNote": "Cosa molti compratori esteri sottovalutano: il sistema italiano non e difficile, e procedurale. Vince chi coordina persone, documenti e tempi.",
    ...
    "roles": [
      "Agenzia immobiliare: facilita trattativa e flusso documentale, ma non garantisce conformita tecnica.",
      "Venditore / proprietario: fornisce documenti e accesso, ma puo non conoscere criticita su permessi o catasto.",
      "Tecnico / geometra / ingegnere: verifica conformita tecnica e urbanistica e coerenza tra stato reale e documenti.",
      "Uffici comunali: fonte di permessi, vincoli e storico conformita.",
      "Banca / mediatore creditizio (se c e mutuo): tempi, perizie e condizioni di approvazione.",
    ...
    "rolesNote": "Reality check: nessuna singola figura e responsabile del tuo risultato complessivo in automatico. L assistenza coordinata cambia tutto.",
    "rolesNotaryCta": "Vai all'articolo completo sul notaio",
    "rolesNotaryCtaHref": "/guides/notary",
    "serviceTitle": "Cosa facciamo di diverso (e perche protegge il tuo acquisto)",
    "serviceText": "Il nostro servizio non e solo traduzione e non e solo ricerca annunci. Coordiniamo tutto il processo per ridurre i punti ciechi tipici dei compratori esteri.",
    "service": [
      ...
      "Proteggiamo il tuo tempo: meno vicoli ciechi e decisioni piu chiare."
    ],
    ...
    "serviceSecondaryCtaHref": "/contact",
    "risksTitle": "Cosa puo andare storto se gestisci tutto da solo",
    "risks": [
      "Impegnarsi troppo presto: firma o caparra prima del completamento dei controlli.",
      "Difformita documentale: stato reale dell immobile diverso da catasto o permessi.",
      "Vincoli nascosti: servitu, accessi, regole condominiali, elementi tutelati.",
      "Sorprese comunali: permessi mancanti, limiti d uso, blocco interventi previsti.",
      "Sottostima costi: pensare che il prezzo annuncio sia il costo finale.",
      "Errori di comunicazione: piccoli fraintendimenti che diventano problemi legali o finanziari."
    ],
    "risksNote": "Attenzione: la maggior parte dei problemi non emerge nella prima conversazione. Emergono dopo, quando tornare indietro e costoso.",
    "risksCta": "Vai alla FAQ",
    "risksCtaHref": "/faq",
    "costsTitle": "Costi: categorie principali (senza numeri dettagliati)",
    "costsIntro": "Ogni operazione e diversa, ma queste voci vanno sempre pianificate.",
    "costs": [
      "Tasse legate all acquisto (in base a tipo immobile e profilo acquirente)",
      "Costi notarili (onorari e registrazione)",
      "Commissione agenzia (secondo struttura pagamento e condizioni)",
      "Verifiche tecniche (sopralluogo, conformita, documentazione)",
      "Spese amministrative (documenti, certificati, registrazioni)",
      "Supporto traduzione e interpretariato",
      "Setup post-acquisto (utenze, assicurazione, onboarding condominio)"
    ],
    ...
    "quick": [
      ...
      "Sai chi verifica conformita tecnica e urbanistica e in quale fase?",
      "Hai un piano temporale realistico, soprattutto se e previsto finanziamento?",
